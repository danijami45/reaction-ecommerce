                ...
                >
                  <div className="slide-content">
                    ...
                    <div className="slide-cta">
                      <ButtonShop href="#1">Shop New Arrivals</ButtonShop>
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <div className="slide-content">
                    ...
                    <p>
                      ...
                      lorem ut libero malesuada feugiat. Mauris blandit aliquet
                      elit, eget tincidunt nibh pulvinar.
                    </p>
                    <div className="slide-cta">
                      <ButtonShop href="#2">Shop Sale</ButtonShop>
                    </div>
                ...
                >
                  <div className="slide-content">
                    ...
                    <p>
                      ...
                      sit amet dui. Donec rutrum congue leo eget malesuada. Cras
                      ultricies ligula sed magna dictum porta.
                    </p>
                    <div className="slide-cta">
                      <ButtonShop href="#3">Explore Collection</ButtonShop>
                    </div>
